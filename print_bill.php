...
<?php	//Include database connection details
	...
	if(!$db) {
		...
		<tr><td style='font-size:24px; padding:5px; margin-left:-10px;' align='right'>Customer Name:</td><td style='font-size:24px; width:75%;'>$customer_name</td></tr></table>";
...
$qry1="SELECT * from bill_details where bill_no='$bill_no'";
		...
		while($row1 = mysql_fetch_array($res1)){
			...
			$box_item_amt = $row1['box_item_amt']; //per item total items in box amount(net amount of boxes ordered)
