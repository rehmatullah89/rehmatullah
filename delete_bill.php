...
require_once('config.php');
	...
	$bill_no = $_GET['id'];
	$bill_info = mysql_query("Select * from distributor_bills where bill_no=".$bill_no."");
	$bill_details = mysql_query("Select * from bill_details where bill_no=".$bill_no."");
...
mysql_query("DELETE FROM bill_details WHERE bill_no=".$bill_no."");
mysql_query("DELETE FROM distributor_bills WHERE bill_no=".$bill_no."");
