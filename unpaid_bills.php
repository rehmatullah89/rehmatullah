...
<!-- content -->
	...
	$tbl_name="distributor_bills";		//your table name
	...
	*/
	...
	$targetpage = "unpaid_bills.php"; 	//your file name  (the name of this file)
...
<tr>
	<th>Bill No.</th><th>Bill Date</th><th>Distributor Name</th><th>Type</th><th>Customer Name</th><th>Total Bill</th><th>Delete Bill</th><th>Print Slip</th>
</tr>
	<?php
	$i=1;
	$new_bill_no=0;
		while($row = mysql_fetch_array($result))
		{
		 ...
		 $distributor_for = @mysql_result(mysql_query('Select distributor_for from distributors_list where Name_distributor="'.$distributor_name.'"'),0);
	...
	?>
	<tr>
	<td><?php echo $new_bill_no;?></td><td><?php echo $date_bill;?></td><td><?php echo $distributor_name;?></td><td><?php echo ucfirst($distributor_for); ?></td><td><?php echo $customer_name;?></td><td><?php echo $total_amount;?></td> <!-- <td><?php //echo $amount_paid;?></td><td><?php //echo $total_amount-$amount_paid;?></td><td>
	<?php //if($bill_status == 1) echo "-";
	//else {?>
	<a href="pay_bill.php?b_id=<?php //echo $bill_no;?>"><input type="button" name="payNow" value="Pay Now"></a><?php //}?></td> --><td><a onclick="return confirm('Are u sure, you want to delete this bill?');" href="delete_bill.php?id=<?php echo $bill_no; ?>">Delete Bill</a></td><td><a href="print_bill.php?b_id=<?php echo $bill_no;?>"> <input type="button" name="printNow" value="Print Bill" <?php if ($printed=='1') echo 'style=color:red;'; ?>></a></td>
</tr>	 
