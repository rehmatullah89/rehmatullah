			...
			<div class="header-box">
				<div class="left">
					<div class="right">
						...
						<h1><a href="index.html"><span>Sanva</span><font style="color: red;">KEC</font>.com</a></h1>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="inside">
				<ul class="banners wrapper">
					<li><a href="add_product.php">Add Prodcut</a></li>
					<li><a href="add_series.php">Add Series</a></li>
                    <li><a href="view_series.php">Delete Series</a></li>
				</ul>
				<h4 align="right"><a href="logout.php" style="color:red;">(Log Out)</a></h4><h2 class="extra">Products Summary</h2>
...
$q2="SELECT * FROM products where series_name='$s_name' and (cotton_quantity>0 OR remaining_box_qty>0)";
											...
											<div class="right-bot-corner maxheight">
												<div class="left-bot-corner maxheight">
													<div class="inner">
														...
														<ul class="info-list">
															<li><span><b>Item name</b></span><b>Qunatity</b></li>
																														<?php
															while($row=mysql_fetch_array($r2))
															{
															echo "<li><span>".$row['item_name']."</span>".$row['cotton_quantity'].".".$row['remaining_box_qty']."cottons</li>";
															}
															?>
														</ul>
