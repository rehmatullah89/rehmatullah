...
?>
	...
	<form action="order_exec.php" method="post" onsubmit="return confirm('Are you sure you want to complete this Order?');">
	<h4>Click to Change! ->[<a style="color:red;" href="manual_order.php?tab=orders">Click For Customer Bill</a>]</h4>
