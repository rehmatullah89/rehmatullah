...
<!-- content -->
	...
	$tbl_name="reverse_bills";		//your table name
	...
	*/
	...
	$targetpage = "reverse_bills_list.php"; 	//your file name  (the name of this file)
...
<tr>
	<th>Bill No.</th><th>Bill Date</th><th>Distributor Name</th><th>Type</th><th>Customer Name</th><th>Total Bill</th><th>Print Slip</th>
</tr>
	<?php
	$i=1;
	$new_bill_no=0;
	...
	//else {?>
	<a href="pay_bill.php?b_id=<?php //echo $bill_no;?>"><input type="button" name="payNow" value="Pay Now"></a><?php //}?></td> --><td><a href="print_reverse_bill.php?b_id=<?php echo $bill_no;?>"> <input type="button" name="printNow" value="Print Bill" <?php if ($printed=='1') echo 'style=color:red;'; ?>></a></td>
</tr>	 
